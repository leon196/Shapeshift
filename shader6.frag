...
void main(void)
{
	...
	for (int r = 0; r < rayCount; ++r) 
	{
		...
		float dd = substraction(box(p, vec3(0.45, 2.0, 0.45)), d);
		dd = substraction(box(p, vec3(2.0, 0.45, 0.45)), dd);
		dd = substraction(box(p, vec3(0.45, 0.45, 2.0)), dd);
		
		float ddd = substraction(box(p, vec3(0.45, 2.0, 0.45)), d);
